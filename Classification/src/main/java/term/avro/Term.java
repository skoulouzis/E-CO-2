...
public class Term extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static term.avro.Term.Builder newBuilder() {
    return new term.avro.Term.Builder();
  }
  
  /** Creates a new Term RecordBuilder by copying an existing Builder */
  public static term.avro.Term.Builder newBuilder(term.avro.Term.Builder other) {
    return new term.avro.Term.Builder(other);
  }
  
  /** Creates a new Term RecordBuilder by copying an existing Term instance */
  public static term.avro.Term.Builder newBuilder(term.avro.Term other) {
    return new term.avro.Term.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Term>
    ...
    private Builder() {
      super(term.avro.Term.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(term.avro.Term.Builder other) {
      super(other);
    ...
    private Builder(term.avro.Term other) {
            super(term.avro.Term.SCHEMA$);
      if (isValidValue(fields()[0], other.uid)) {
        this.uid = data().deepCopy(fields()[0].schema(), other.uid);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'uid' field */
    public term.avro.Term.Builder setUid(java.lang.CharSequence value) {
    ...
    public term.avro.Term.Builder clearUid() {
      uid = null;
    ...
    /** Sets the value of the 'lemma' field */
    public term.avro.Term.Builder setLemma(java.lang.CharSequence value) {
    ...
    public term.avro.Term.Builder clearLemma() {
      lemma = null;
    ...
    /** Sets the value of the 'glosses' field */
    public term.avro.Term.Builder setGlosses(java.util.List<java.lang.CharSequence> value) {
    ...
    public term.avro.Term.Builder clearGlosses() {
      glosses = null;
    ...
    /** Sets the value of the 'originalTerm' field */
    public term.avro.Term.Builder setOriginalTerm(java.lang.CharSequence value) {
    ...
    public term.avro.Term.Builder clearOriginalTerm() {
      originalTerm = null;
    ...
    /** Sets the value of the 'url' field */
    public term.avro.Term.Builder setUrl(java.lang.CharSequence value) {
    ...
    public term.avro.Term.Builder clearUrl() {
      url = null;
    ...
    /** Sets the value of the 'categories' field */
    public term.avro.Term.Builder setCategories(java.util.List<java.lang.CharSequence> value) {
    ...
    public term.avro.Term.Builder clearCategories() {
      categories = null;
    ...
    /** Sets the value of the 'altLables' field */
    public term.avro.Term.Builder setAltLables(java.util.List<java.lang.CharSequence> value) {
    ...
    public term.avro.Term.Builder clearAltLables() {
      altLables = null;
    ...
    /** Sets the value of the 'buids' field */
    public term.avro.Term.Builder setBuids(java.util.List<java.lang.CharSequence> value) {
    ...
    public term.avro.Term.Builder clearBuids() {
      buids = null;
    ...
    /** Sets the value of the 'nuids' field */
    public term.avro.Term.Builder setNuids(java.util.List<java.lang.CharSequence> value) {
    ...
    public term.avro.Term.Builder clearNuids() {
      nuids = null;
    ...
    /** Sets the value of the 'confidence' field */
    public term.avro.Term.Builder setConfidence(double value) {
    ...
    public term.avro.Term.Builder clearConfidence() {
