 ...
 * @author S. Koulouzis
 */
public class AprioriTermExtractionTest {

  public AprioriTermExtractionTest() {
  }
  ...
  /**
   * Test of run method, of class
   */
  @Test
  public void testRun() throws Exception {
    String[] args = new String[]{TMP_IN_PATH_1, TMP_OUT_PATH_1, "0.05", "2"};
    ToolRunner.run(new AprioriTermExtraction(), args);
  }
